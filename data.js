const STORE_DEFAULT = {
  ...
  products: [
    { name:"Netflix", category:"streaming", desc:"Cuenta o perfil por 30 días.", price:"15", cost:"8", image:"", logo:"NETFLIX", color:"#e50914", offer:true, active:true },
    { name:"Disney+", category:"streaming", desc:"Entretenimiento familiar y estrenos.", price:"10", cost:"5", image:"", logo:"Disney+", color:"#16a6ff", offer:true, active:true },
    { name:"Crunchyroll", category:"streaming", desc:"Anime, estrenos y series populares.", price:"10", cost:"5", image:"", logo:"Crunchyroll", color:"#f47521", offer:false, active:true },
